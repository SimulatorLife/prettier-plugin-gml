...
import { writeManualJsonArtifact } from "./manual/file-helpers.js";
import {
    DEFAULT_MANUAL_REPO,
...
} from "./manual/command-options.js";
import { wrapInvalidArgumentResolver } from "../core/command-parsing.js";
import { createManualAccessContexts } from "./manual/context.js";
import {
    decodeManualKeywordsPayload,
    decodeManualTagsPayload
} from "./manual/payload-validation.js";
