...
export default function (hljs) {
    ...
    const STRING_ESCAPE = {
        scope: "literal",
        variants: [{ match: /\\u[a-fA-F0-9]{1,6}/ }, { match: /\\[^\n]/ }]
    };
    /**
    ...
    const STRING = {
        variants: [
            ...
            },
            {
                ...
                illegal: String.raw`\n`,
                contains: [STRING_ESCAPE, STRING_NUMERICAL_SUBSTITUTION]
            }
        ]
    };
    /**
    ...
    const PREPROCESSOR = {
        variants: [
            {
                match: [/#macro\s+/, VALID_IDENTIFIER_REG],
                className: {
                    1: "keyword",
                    2: "literal"
                }
     ...
     */
    const COMMENT = {
        variants: [COMMENT_LINE, hljs.C_BLOCK_COMMENT_MODE]
    };
    /**
    ...
    const PROP_ACCESS = [
        {
            match: ["global", DOT_ACCESSOR_REG, VALID_IDENTIFIER_REG],
            className: {
                1: "literal",
                3: "variable-global"
            }
        ...
        {
            match: [DOT_ACCESSOR_REG, VALID_IDENTIFIER_REG, /\s*\(/],
            className: {
                2: "function"
            }
        },
        {
            match: [DOT_ACCESSOR_REG, VALID_IDENTIFIER_REG],
            className: {
                2: "variable-instance"
            }
        }
    ...
    const USER_ASSET_CONSTANT = {
        ...
        variants: [{ begin: "spr_" }, { begin: "obj_" }]
    };
    /**
    ...
    const STRUCT_LITERAL_MEMBER = {
        match: [/\b/, VALID_IDENTIFIER_REG, /\s*:/],
        className: {
            2: "variable-instance"
        }
    };
    ...
    const FUNCTION_DECLARATION = {
        match: ["function", /\s+/, VALID_IDENTIFIER_REG, /\s*?\(/],
        className: {
            1: "keyword",
            3: "function"
        }
    ...
    const ENUM_DEFINITION = {
        begin: [/enum/, /\s+/, VALID_IDENTIFIER_REG, /\s*{/],
        end: "}",
        className: {
            1: "keyword",
            3: "literal"
        ...
        contains: [
            COMMENT,
            {
                begin: [VALID_IDENTIFIER_REG, /\s*=\s*/],
                end: /,|\n|}/,
                className: {
                    1: "literal"
                },
