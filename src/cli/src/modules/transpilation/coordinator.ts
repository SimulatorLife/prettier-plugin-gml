...
export function transpileFile(
    ...
    try {
        ...
        const scriptNameFromPath = resolveScriptFileNameFromSegments(getRuntimePathSegments(filePath));
        const symbolId = scriptNameFromPath ? `gml/script/${scriptNameFromPath}` : defaultSymbolId;
