var str =
    "SMF demo 2: Interpolating between animations:\n" +
    "FPS: " + string(fps) + " FPS_real: " + string(fps_real) + "\n" +
    "This shows how a basic animated model can be drawn, and how to " +
    "interpolate smoothly between animations\n" +
