...
/**
 * Enumerated constants for refactoring conflict severity levels.
 *
 * Severity classifies how critical a detected conflict is. This enum
 * centralizes valid severity values to prevent stringly-typed branches and
 * provides a single source of truth for validation.
 *
 * @example
 * // Use typed constants instead of raw strings
 ...
 *
 * @example
 * const severity = requireConflictSeverity(conflict.severity, "conflict entry");
 */
