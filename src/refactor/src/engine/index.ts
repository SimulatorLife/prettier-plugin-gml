...
export class RefactorEngine {
    ...
    constructor({ parser, semantic, formatter }: any = {}) {
        this.parser = parser;
     ...
     */
    async applyWorkspaceEdit(workspace, options = undefined) {
        const opts = options ?? {};
     ...
     */
    async prepareRenamePlan(request, options = undefined) {
        const opts = options ?? {};
        const { validateHotReload = false, hotReloadOptions = {} } = opts;
