...
export declare const PROJECT_INDEX_CACHE_MAX_SIZE_ENV_VAR = "GML_PROJECT_INDEX_CACHE_MAX_SIZE";
...
export declare function loadProjectIndexCache(descriptor: any, fsFacade?: {
...
export declare function saveProjectIndexCache(descriptor: any, fsFacade?: {
    readDir(targetPath: any): Promise<string[]>;
    stat(targetPath: any): Promise<import("fs").Stats>;
    readFile(targetPath: any, encoding?: string): Promise<NonSharedBuffer & string>;
    writeFile(targetPath: any, contents: any, encoding?: string): Promise<void>;
...
export declare function deriveCacheKey({ filepath, projectRoot, formatterVersion }?: {
