declare const PROJECT_INDEX_GML_CONCURRENCY_ENV_VAR = "GML_PROJECT_INDEX_CONCURRENCY";
declare const PROJECT_INDEX_GML_CONCURRENCY_BASELINE = 4;
declare const PROJECT_INDEX_GML_MAX_CONCURRENCY_ENV_VAR = "GML_PROJECT_INDEX_MAX_CONCURRENCY";
...
declare function clampConcurrency(value: any, { min, max, fallback }?: {
    min?: number;
    max?: any;
    fallback?: any;
}): any;
