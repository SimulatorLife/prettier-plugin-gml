...
const projectIndexConcurrencyLimitConfig = createEnvConfiguredValueWithFallback({
    ...
    resolve: (value, { fallback }) => normalizeConcurrencyValue(value, {
        min: MIN_CONCURRENCY,
...
function clampConcurrency(value, { min = MIN_CONCURRENCY, max = getDefaultProjectIndexGmlConcurrencyLimit(), fallback = getDefaultProjectIndexGmlConcurrency() } = {}) {
...
function normalizeConcurrencyValue(value, { min = MIN_CONCURRENCY, max = getDefaultProjectIndexGmlConcurrencyLimit(), fallback, onInvalid = min } = {}) {
...
export { DEFAULT_PROJECT_INDEX_GML_CONCURRENCY, DEFAULT_PROJECT_INDEX_GML_CONCURRENCY_LIMIT, PROJECT_INDEX_GML_CONCURRENCY_BASELINE, PROJECT_INDEX_GML_CONCURRENCY_ENV_VAR, PROJECT_INDEX_GML_MAX_CONCURRENCY_BASELINE, PROJECT_INDEX_GML_MAX_CONCURRENCY_ENV_VAR, applyProjectIndexConcurrencyEnvOverride, applyProjectIndexConcurrencyLimitEnvOverride, clampConcurrency, getDefaultProjectIndexGmlConcurrency, getDefaultProjectIndexGmlConcurrencyLimit, setDefaultProjectIndexGmlConcurrency, setDefaultProjectIndexGmlConcurrencyLimit };
