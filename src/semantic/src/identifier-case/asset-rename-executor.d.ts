...
declare function readJsonFile(
    fsFacade: any,
    absolutePath: any,
    cache: any
): any;
declare function getObjectAtPath(json: any, propertyPath: any): any;
declare function updateReferenceObject(
    json: any,
    propertyPath: any,
    newResourcePath: any,
    newName: any
): boolean;
declare function ensureWritableDirectory(
    fsFacade: any,
    directoryPath: any
): void;
declare function ensureWritableFile(fsFacade: any, filePath: any): void;
export declare function createAssetRenameExecutor({
    projectIndex,
    fsFacade,
    logger
}?: {
