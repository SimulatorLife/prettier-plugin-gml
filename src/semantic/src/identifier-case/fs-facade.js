import { readFileSync as nodeReadFileSync, writeFileSync as nodeWriteFileSync, renameSync as nodeRenameSync, accessSync as nodeAccessSync, statSync as nodeStatSync, mkdirSync as nodeMkdirSync, existsSync as nodeExistsSync } from "node:fs";
