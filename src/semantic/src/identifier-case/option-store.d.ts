export declare function setIdentifierCaseOption(
    options: any,
    key: any,
    value: any
): void;
export declare function deleteIdentifierCaseOption(
    options: any,
    key: any
): void;
export declare function getIdentifierCaseOptionStore(storeKey: any): any;
export declare function clearIdentifierCaseOptionStore(storeKey: any): void;
export {
