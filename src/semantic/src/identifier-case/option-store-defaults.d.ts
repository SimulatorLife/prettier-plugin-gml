declare const IDENTIFIER_CASE_OPTION_STORE_MAX_ENTRIES_ENV_VAR = "GML_IDENTIFIER_CASE_OPTION_STORE_MAX_ENTRIES";
...
declare function setDefaultIdentifierCaseOptionStoreMaxEntries(maxEntries: any): any;
