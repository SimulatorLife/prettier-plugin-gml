...
const { DeprecatedBuiltinVariables: { buildDeprecatedBuiltinVariableReplacements, getDeprecatedBuiltinReplacementEntry }, Utils: { createResolverController } } = Core;
export { GameMakerSyntaxError } from "./src/gml-syntax-error.js";
export { sanitizeConditionalAssignments, applySanitizedIndexAdjustments } from "./src/conditional-assignment-sanitizer.js";
...
export { default as GameMakerLanguageParserVisitor, VISIT_METHOD_NAMES } from "./src/runtime/game-maker-language-parser-visitor.js";
export { default as GameMakerLanguageParserListener, LISTENER_METHOD_NAMES } from "./src/runtime/game-maker-language-parser-listener.js";
...
export { buildDeprecatedBuiltinVariableReplacements, getDeprecatedBuiltinReplacementEntry, createResolverController };
export { getStructPropertyAccess, isBinaryOperator } from "./src/ast/node-helpers.js";
