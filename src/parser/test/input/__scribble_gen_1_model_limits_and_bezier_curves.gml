...
function __scribble_gen_1_model_limits_and_bezier_curves() {
    ...
    var _bezier_do = ((_element_bezier_array[0] != _element_bezier_array[4]) or
    (_element_bezier_array[1] != _element_bezier_array[5]));
    if (_bezier_do) {
        ...
        var _bezier_lengths = array_create(SCRIBBLE_BEZIER_ACCURACY, 0);
        var _x1 = undefined;
        var _y1 = undefined;
        var _x2 = 0;
        var _y2 = 0;
        ...
        if ((_model_max_width >= 0) and !is_infinity(_model_max_width)) {
            __scribble_trace(
                ((("Warning! Maximum width (" + string(_model_max_width)) +
                ") has been replaced with Bezier curve length (") + string(_dist)) +
