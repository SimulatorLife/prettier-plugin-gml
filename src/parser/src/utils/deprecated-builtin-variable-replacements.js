...
export function getDeprecatedBuiltinReplacementEntry(name) {
    ...
    // This module is responsible for constructing the map; callers can cache
    // the built map if needed. For convenience expose a single-entry lookup
    // that constructs the full map on first use.
