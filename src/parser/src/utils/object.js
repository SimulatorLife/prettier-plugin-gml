 ...
 * @returns {value is object} `true` when {@link value} can safely accept property access.
 */
 ...
 *
 * Centralizes the defensive guards sprinkled across CLI modules so callers can
 * surface readable diagnostics without repeating null/undefined checks or
 * worrying about serialization failures. Strings are quoted for clarity, numeric primitives preserve their native formatting, and
