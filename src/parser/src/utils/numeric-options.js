...
const { Utils: { coercePositiveInteger, coerceNonNegativeInteger, coercePositiveIntegerOption, resolveIntegerOption, normalizeNumericOption, createNumericTypeErrorFormatter } } = Core;
