...
import { DEFAULT_COMMENTED_OUT_CODE_PATTERNS, DEFAULT_LINE_COMMENT_OPTIONS, LINE_COMMENT_BANNER_DETECTION_MIN_SLASHES, normalizeLineCommentOptions } from "./line-comment-options.js";
import { isObjectLike } from "./comment-boundary.js";
import { normalizeOptionalParamToken } from "./optional-param-normalization.js";
const { 
// TODO: Flatten this
AST: { getCommentValue }, Utils: { getNonEmptyTrimmedString, toTrimmedString, hasOwn, isRegExpLike, createResolverController } } = Core;
...
function formatLineComment(comment, lineCommentOptions = DEFAULT_LINE_COMMENT_OPTIONS) {
