...
function printComment(commentPath, options) {
    ...
    console.log(`[DEBUG] comment.type: ${comment.type}`);
    console.log(`[DEBUG] Core.isCommentNode: ${Core.isCommentNode(comment)}`);
    console.log(`[DEBUG] _structPropertyTrailing: ${comment?._structPropertyTrailing}`);

    if (!Core.isCommentNode(comment)) {
        console.log(`[DEBUG] Not a comment node`);
    ...
    if (comment?._structPropertyTrailing) {
        console.log(`[DEBUG] _structPropertyTrailing is true`);
    ...
    switch (comment.type) {
        case "CommentBlock": {
            console.log(`[DEBUG] Printing CommentBlock`);
            return `/*${comment.value}*/`;
        }
        case "CommentLine": {
            console.log(`[DEBUG] Printing CommentLine`);
            ...
            console.log(`[DEBUG] formatLineComment result: "${result}"`);
            return result;
        }
        default: {
