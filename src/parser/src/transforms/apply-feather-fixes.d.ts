...
export declare function applyRemovedIndexAdjustments(target: any, adjustments: any): void;
export declare function getFeatherDiagnosticFixers(): Map<any, any>;
export declare function applyFeatherFixes(ast: any, { sourceText, preprocessedFixMetadata, options }?: {}): any;
