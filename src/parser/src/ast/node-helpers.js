...
/**
 * Inspect a left-hand member expression and, when it references a property
 * on the provided identifier root, return a compact descriptor for the
 * property node and its start index. This mirrors the canonical helper used
 * by the plugin transforms and keeps the parser-local transform logic
 * self-contained.
 */
