...
/// @desc This is the description for this function. The description JSDoc tag must come after the param tags and before the returns tag.
/// @param {string|Array[String} _param1 This is parameter 1
