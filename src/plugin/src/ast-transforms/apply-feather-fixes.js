...
function moveGpuPopStateCallOutOfConditional(node, parent, property, diagnostic) {
    ...
    const consequentBody = Array.isArray(consequentBlock.body) ? consequentBlock.body : null;
    ...
    if (!callExpression || !isIdentifierWithName(callExpression.object, "gpu_pop_state")) {
        return null;
    }
