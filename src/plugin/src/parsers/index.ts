...
export { gmlParserAdapter, createGmlParserAdapter } from "./gml-parser-adapter.js";
export type { ScopeTrackerFactory, GmlParserAdapterConfig, GmlParserAdapterOptions } from "./gml-parser-adapter.js";
export {
