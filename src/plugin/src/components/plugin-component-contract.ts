...
export function selectPluginComponentContractEntries(source: GmlPluginComponentContract): GmlPluginComponentContract {
...
export function createPluginComponentContractNormalizer(context?: string) {
    ...
    return function normalizePluginComponentContract(candidate: unknown): GmlPluginComponentContract {
        ...
        return selectPluginComponentContractEntries(components as GmlPluginComponentContract);
    };
}
