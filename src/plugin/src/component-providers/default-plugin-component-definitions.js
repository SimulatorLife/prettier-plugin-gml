...
function resolveParserDefinitions() {
    return {
        "gml-parse": {
            ...gmlParserAdapter,
...
function resolvePrinterDefinitions() {
    return {
        "gml-ast": {
            print,
...
export function resolveDefaultGmlPluginComponentDefinitions() {
    return {
        parsers: resolveParserDefinitions(),
        printers: resolvePrinterDefinitions(),
        options: resolveOptionDefinitions()
    };
}
