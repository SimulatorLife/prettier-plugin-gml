    ...
    return {
        ...
        options: {
            ...
            maxParamsPerLine: {
                ...
                range: { start: 0, end: Infinity },
                description:
                    "Maximum number of arguments allowed on a single line before a function call is forced to wrap. Set to 0 to disable the count-based guard (other readability heuristics may still reflow callback-heavy signatures)."
            },
            applyFeatherFixes: {
                since: "0.0.0",
                type: "boolean",
