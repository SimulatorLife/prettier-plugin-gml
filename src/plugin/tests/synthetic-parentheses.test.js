...
test("flattens multiplication groups in additive assignments", async () => {
    ...
    assert.strictEqual(
        ...
        "Expected additive assignments with multiplication groups to omit redundant synthetic parentheses."
    );
});
