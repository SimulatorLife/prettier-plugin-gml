...
test("omits synthetic parentheses for comparisons joined by logical keywords", async () => {
    const source = [
    ...
    assert.strictEqual(
        formatted,
        expectedLines,
        "Expected logical comparisons joined by 'and' to omit redundant synthetic parentheses."
    );
});
