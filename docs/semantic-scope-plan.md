...
This document captures the semantic analysis, scope management, and transpiler planning that underpin the live-reloading pipeline. The live runtime hooks described in [hot reload](./hot-reload.md) depend on these facilities to turn edited GML into hot-swappable JavaScript patches.
