...
- When providing a JSON review/issue output, ensure that the body of the JSON is in a purely git-diff format that is syntactically valid and can be parsed and applied automatically by git/apply or similar tools.
