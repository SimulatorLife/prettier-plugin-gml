# Agent Instructions
- If checking a diff for a PR and/or PR-commit and it shows as empty or having no visible changes, then treat the **entire codebase** as the context for the task, not that specific commit or diff.
